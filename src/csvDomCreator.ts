export class CSVDomCreator {
    ...
    initializeStringSearchFieldContainer(rowList) {
        ...
        searchField.addEventListener("keypress", (event) => {
            if (event.key == "Enter") {
                ...
                let inputElement: HTMLInputElement = <HTMLInputElement>document.getElementById("stringSearchField");
    ...
    initializeNthRowSearchButtonContainer(rowList) {
        ...
        searchButton.addEventListener("click", () => {
            ...
            let inputElement: HTMLInputElement = <HTMLInputElement>document.getElementById("nthRowSearchField");
